...
## 2026-02-25：合并 Vue2 vs Vue3 布局对照文档 ✅

### 更新的文档

1. **`docs/VUE2_VUE3_LAYOUT_MIGRATION.md`** ⭐
   - 合并两份重复草稿为单一文档：布局/导航/响应式/性能能力对照 + 当前缺口清单 + 可小步实施方案

2. **`docs/README.md`**
   - 更新最后更新时间：2026-02-24 → 2026-02-25
   - 将 `VUE2_VUE3_LAYOUT_MIGRATION.md` 加入核心阅读索引

---

## 2026-02-24：前端分析文档校准与增量计划 ✅

### 更新的文档

1. **`docs/FRONTEND_ANALYSIS.md`**
...
2. **`docs/README.md`**
   ...
   - 将 `FRONTEND_ANALYSIS.md` 加入核心阅读索引
...
- 新增根目录标准文档：`LICENSE` / `CHANGELOG.md` / `CONTRIBUTING.md` / `SECURITY.md`
- 归档重复的用户手册正文：`docs/archive/USER_MANUAL_DEPRECATED_2026-02-23.md`
- `docs/USER_MANUAL.md` 改为指向 `docs/USER_GUIDE.md` 的“重定向”文档
- 修复 `README.md` 中前端目录与 `.planning` 链接的实际路径
