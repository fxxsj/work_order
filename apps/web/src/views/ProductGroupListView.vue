...
import { createProductGroup, deleteProductGroup, getProductGroup, productGroupApi, updateProductGroup } from '../api/productGroups'
...
const extraParams = () => ({ is_active: active.value === null ? undefined : active.value })
...
async function handleDelete(id: number) {
  ...
  try {
    ...
    ElMessage.error(getHttpErrorMessage(err, '删除失败'))
  } finally {
