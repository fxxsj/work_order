...
def update_plate_making_task_on_artwork_confirmation(
...
def update_plate_making_task_on_foiling_plate_confirmation(
    sender, instance, created, **kwargs
):
...
def cache_embossing_plate_confirmation(sender, instance, **kwargs):
    ...
    if instance.pk:
        try:
            ...
            _plate_confirmation_cache[f"embossing_{instance.pk}"] = (
                old_instance.confirmed
            )
...
def update_plate_making_task_on_embossing_plate_confirmation(
    sender, instance, created, **kwargs
):
