...
class ProductSerializerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.process = Process.objects.create(
            name="印刷", code="print", department_id=1
        )
    ...
    def test_validate_unit_price_exceeds_limit(self):
        ...
        serializer = ProductSerializer(
            data={"code": "PROD-001", "name": "测试产品", "unit_price": 999999999.99}
        )
        self.assertFalse(serializer.is_valid())
        self.assertIn("unit_price", serializer.errors)
    ...
    def test_validate_stock_quantity_negative(self):
        ...
        serializer = ProductSerializer(
            data={"code": "PROD-001", "name": "测试产品", "stock_quantity": -10}
        )
        self.assertFalse(serializer.is_valid())
    ...
    def test_validate_min_stock_greater_than_stock(self):
        ...
        product = Product.objects.create(
            code="PROD-001", name="测试产品", stock_quantity=100, min_stock_quantity=10
        )
...
class ProductAPITest(APITestCase):
    ...
    def test_update_product(self):
        ...
        response = self.client.patch(
            f"/api/products/{product.id}/", update_data, format="json"
        )
...
class ProductMaterialAPITest(APITestCase):
    ...
    def test_create_product_material(self):
        ...
        response = self.client.post("/api/product-materials/", data, format="json")
    ...
    def test_list_product_materials(self):
        ...
        # 创建产品物料
        ProductMaterial.objects.create(product=self.product, material=self.material)
