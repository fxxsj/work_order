...
- [x] **TASK-01**: 施工单创建时立即为所有工序生成草稿任务
- [x] **TASK-02**: 草稿任务可以预览、编辑、删除
- [x] **TASK-03**: 施工单修改工序时提示是否更新已有任务
- [x] **TASK-04**: 草稿任务可以批量操作（批量删除、批量编辑）
- [x] **TASK-05**: 施工单审核通过后，所有草稿任务自动转为正式任务
- [x] **TASK-06**: 施工单审核拒绝后，所有草稿任务自动删除

### 任务分派

- [x] **DISP-01**: 系统根据部门优先级规则自动将任务分派到部门
- [x] **DISP-02**: 支持在配置界面设置每个工序的部门优先级
- [x] **DISP-03**: 部门主管可以将任务分配给部门内的操作员
- [x] **DISP-04**: 操作员可以将未分配的任务认领给自己
- [x] **DISP-05**: 一个任务同时只能分配给一个操作员
- [x] **DISP-06**: 支持智能负载平衡（选择当前任务最少的部门）
...
- [x] **SUP-01**: 部门主管可以查看本部门所有任务
- [x] **SUP-02**: 支持部门主管将任务拖拽分配给操作员
- [x] **SUP-03**: 显示部门内操作员的工作负载统计
- [x] **SUP-04**: 支持部门主管批量分配任务
- [x] **SUP-05**: 支持部门主管重新分配任务（如果未开始）

### 操作员任务中心

- [x] **OP-01**: 操作员可以查看分配给自己的任务
- [x] **OP-02**: 操作员可以查看本部门可认领的任务
- [x] **OP-03**: 支持操作员一键认领任务
- [x] **OP-04**: 显示操作员的个人工作负载统计
- [x] **OP-05**: 支持操作员更新任务进度和完成数量
...
- [x] **PERF-01**: 批量任务生成使用 bulk_create()（避免 N+1 查询）
...
- [x] **CONS-01**: 使用乐观锁防止并发任务认领冲突
- [x] **CONS-02**: 工序修改后同步更新相关任务
- [x] **CONS-03**: 删除施工单时级联删除所有任务
- [x] **CONS-04**: 草稿-正式流转时验证数据完整性

### 权限控制

- [ ] **AUTH-01**: 基于现有 Django 权限系统控制任务访问
- [x] **AUTH-02**: 操作员只能编辑分配给自己的任务
- [x] **AUTH-03**: 部门主管可以编辑本部门所有任务
- [x] **AUTH-04**: 制表人和业务员可以编辑草稿任务
